...
class __Mustache_60411d068d822814ebba69d549a87cb2 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block750542156fc7b51fd001cf8935753aab'),
            ));
...
';
    ...
    public function block750542156fc7b51fd001cf8935753aab($context)
    {
        $indent = $buffer = '';
        $value = $context->findDot('element.frozen');
        if (empty($value)) {
