...
class __Mustache_635a20e5c60e887a01fee9ad425952a0 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block2106cf5781c417e1f955b095cb559ecd'),
            ));
...
';
    ...
    public function block2106cf5781c417e1f955b095cb559ecd($context)
    {
        $indent = $buffer = '';
