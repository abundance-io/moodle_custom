...
class mod_quiz_renderer extends plugin_renderer_base {
	...
	$premium  = json_decode(json_encode($USER->profile))->premium; if($premium == 'yes'){
        $output .= $this->review_form($page, $showall, $displayoptions,
                $this->questions($attemptobj, true, $slots, $page, $showall, $displayoptions),
              $attemptobj);}
	else{
        $output .= 'Upgrade to <a href="http://peaque.study",style= "color:blue">premium</a> to view solutions and detailed explanations for the Quiz';}
